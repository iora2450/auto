...
class SupplierController extends Controller
{
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('suppliers-add')){
            $lims_supplier_gyre = Gire::all();
            $lims_supplier_country = Country::all();
            $lims_supplier_state = State::all();
            $lims_supplier_municipalities = Municipality::with("state")->get();

            return view('supplier.create',compact('lims_supplier_gyre', 'lims_supplier_country', 'lims_supplier_state', 'lims_supplier_municipalities'));
    ...
    public function edit($id)
    {
        ...
        if($role->hasPermissionTo('suppliers-edit')){
            ...
            $lims_supplier_country = Country::all();
            $lims_supplier_state = State::all();
            $lims_supplier_municipality = Municipality::all();
            
            return view('supplier.edit',compact('lims_supplier_data', 'lims_supplier_gyre', 'lims_supplier_country', 'lims_supplier_state', 'lims_supplier_municipality'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
