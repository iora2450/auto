                        ...
                        <?php echo Form::open(['route' => ['user.update', $lims_user_data->id], 'method' => 'put', 'files' => true]); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mt-3">
                                        <label><strong><?php echo e(trans('file.Email Purchase')); ?> *</strong></label>
                                        <input type="email_purchase" name="email_purchase" placeholder="example@example.com" required class="form-control" value="<?php echo e($lims_user_data->email_purchase); ?>">
                                        <?php if($errors->has('email_purchase')): ?>
                                       <span>
                                           <strong><?php echo e($errors->first('email_purchase')); ?></strong>
                                        </span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="form-group mt-3">
                                        <label><strong><?php echo e(trans('file.Name Purchase')); ?> *</strong></label>
                                        <input type="name_purchase" name="name_purchase" placeholder="Name purchase" required class="form-control" value="<?php echo e($lims_user_data->name_purchase); ?>">
                                        <?php if($errors->has('name_purchase')): ?>
                                       <span>
                                           <strong><?php echo e($errors->first('name_purchase')); ?></strong>
                                        </span>
                                        <?php endif; ?>
                                    </div>
                                </div>                              
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/instruquimica/public_html/sistema/resources/views/user/edit.blade.php ENDPATH**/ ?>