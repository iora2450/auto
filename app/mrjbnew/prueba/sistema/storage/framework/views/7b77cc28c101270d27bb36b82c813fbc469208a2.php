                             ...
                             <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>TIPO *</label>
                                            <select required name="tipo_solicitud" class="selectpicker form-control" data-live-search="true" id="tipo_solicitud" data-live-search-style="begins" title="TIPO">
                                              <option  VALUE='cotizacion'>COTIZACION</option>
                                              <option  VALUE='remision'>NOTA DE REMISION</option>
                                            </select>
                                        </div>
                                    </div>
                                   ...
                                   <div class="col-md-6">
                                         <div class="form-group">
                                            <label>
                                               Correlativo(Solo aplica para nota de remision)
                                            </label>
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type='text' class="form-control" name='credit_days'  id='credit_days' required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                   <div class="form-group">
                                   ...
                                   <div class="form-group">
                                            <label>Validez *</label>
                                            <input type='text'  class="form-control" name='validity'  id='validity' required>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Tiitulo*</label>
                                            <input type='text' class="form-control" name='tittle'  id='tittle' required value='COTIZACIÓN DE EQUIPO Y CONSUMIBLES'>
                                        </div>
                                    </div>
                                    <!--
                                    <div class="col-md-4">
                                ...
                                -->
                                   ...
                                   <div class="form-group">
                                            ...
                                            <input type='text'  class="form-control" name='cell_seller'  id='cell_seller' required>
                                        </div>
                                    </div>
                                   </div>
                             ...
                             <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type='text'  class="form-control" name='method_pay'  id='method_pay' required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                   <div class="form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/instruquimica/public_html/sistema/resources/views/quotation/create.blade.php ENDPATH**/ ?>