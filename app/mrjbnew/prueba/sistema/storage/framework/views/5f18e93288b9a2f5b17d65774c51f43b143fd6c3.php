                ...
                <div class="modal-body">
                    <form id='actualiza_fechas'>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="fecha_confirmacion" id="fecha_confirmacion" class="form-control" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="deadline_delivery_date"  id="deadline_delivery_date"  class="form-control" required>
                        </div>
        ...
        <table id="purchase-table" class="table purchase-list" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>Fecha estimada de arribo</th>
...
<div id="purchase-details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
          <header style='width: 100%'><img  id='encabezado' src='' style="width: 100%;"></header>
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;"><strong>PO NUMBER:</strong>  
                        <label style='text-transform: uppercase;' id='po_number'></label>
                        <label for=""> - </label>
                        <label style='text-transform: uppercase;' id='suppliers_name'></label>
                    </i>
                    <br>
                </div>
            </div>
                ...
                .mayusculasNegritas{font-weight: bold; }
            </style>
            <table style='width: 100%'>
                <tr>
                    <td style='width: 60%'>
                         <table>
                            <tr>
                                <td colspan='2' width="" class='fondoAzul'>Please direct all linquires to:</td>
                            </tr>
                            <tr>
                            
                                <td colspan='2' width="" class='fondoAzul'>Phone no:<br>Fax no:</td>
                                <td>Phone No: (503) 2284-7413; 7534-1582
                                 <br>(503) 2284-7413 </td>
                            </tr>
                                <tr>
                            
                                <td colspan='2' width="" class='fondoAzul'>Attn:</td>
                                <td> <label id='name_purchase'></label>: <label id='email_purchase'></label> </td>
                            </tr>
                    ...
                    <td  style='width: 40%'>
                        ...
                        <table border=1>
                            <tr>
                                <td class='fondoAzul' style='width:35%'>To:</td>
                                <td><label id='email_suppliers'></label></td>
                            </tr>
                           
                            <tr>
                                <td class='fondoAzul'>P.O. DATE:</td>
                                <td><label id='podate'></label> </td>
                            </tr>
                            <tr>
                                <td class='fondoAzul'>Terms:</td>
                                <td><label id='terms'></label></td>
                            </tr>
                               <tr>
                                <td class='fondoAzul'>Ship via:</td>
                                <td>Best Way</td>
                            </tr>
            ...
            <table>
                <tr>
                    <td class='mayusculasNegritas'>CHEMISTRY APPLICATION</td>
                    <td> <label id='chemistry_application'></label></td>
                </tr>
               <tr>
                    <td class='mayusculasNegritas'>END USER</td>
                    <td> <label id='customer_name'></label></td>
                </tr>
                <tr>
                    <td class='mayusculasNegritas'>SERIAL NUMBER</td>
                    <td> <label id='serial'></label></td>
                </tr>
               <tr>
                    <td class='mayusculasNegritas' colspan=2>ADDRESS: <br><label id='customer_address'></label></td>
            ...
            <table class="table table-bordered product-purchase-list">
                <thead>
                    <th class='fondoAzul'>Item</th>
                    <th class='fondoAzul'>Qty</th>
                    <th class='fondoAzul'>Part Number</th>
                    <th class='fondoAzul'>Description</th>
                    <th class='fondoAzul'>Dealer Price</th>
                    <th class='fondoAzul'>Additional<br> Discount</th>
                    <th class='fondoAzul'>Total <br>Price($)</th>
                </thead>
                <tbody>
                </tbody>
            </table>
...
*/
    ...
    function purchaseDetails(purchase){
        ...
        */
        ...
        /*Nuevos campos*/
        $("#referencia").text(purchase[1]) 
        $("#podate").text(purchase[0]) 
        $("#type_purchase").text(purchase[25]) 
        $("#customer_name").text(purchase[26]) 
        $("#customer_address").text(purchase[27]) 
        $("#serial").text(purchase[28]) 
        $("#chemistry_application").text(purchase[29]) 
        $("#address_supp").text(purchase[11])
        $("#email_suppliers").text(purchase[30])
        $("#terms").text(purchase[31])
        $("#name_purchase").text(purchase[32])
        $("#email_purchase").text(purchase[33])
        $("#po_number").text(purchase[34])
        $("#suppliers_name").text(purchase[35])

       // alert(purchase[11])


         ruta="./public/img/header_compra.jpg"
        if(purchase[25]==2){
         ruta= "./public/img/header_garantia.jpg"

        }

        $("#encabezado").attr("src", ruta);
        ...
        $.get('purchases/product_purchase/' + purchase[3], function(data){
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong>TOTAL<br>Estimated Freight<br>U.S Dollars Total</strong></td>';
           // cols += '<td>' + purchase[13] + '</td>';
           // cols += '<td></td>';
           // cols += '<td>' + purchase[14] + '</td>';
            cols += '<td>' + purchase[15] + '<br><br>' + purchase[15] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
...
*/
        ...
        var htmlfooter = "<table><tr><td><table><tr><td>Ship to:<br><b>INSTRUQUIMICA S.A de C.V</b><br>Calle San Antonio Abad, pasaje valdivieso #11 San Salvador, El Salvador<br>Attn:"+purchase[32]+"<br>"+purchase[33]+"<br>Tel:(503)2284-7413, 7534-1582</td></tr></table></td><td><table><tr><td>invoice to:<br><b>INSTRUQUIMICA S.A de C.V</b><br>Calle San Antonio Abad, pasaje valdivieso #11 San Salvador, El Salvador<br>Attn: "+purchase[32]+"<br>"+purchase[33]+"<br>Tel:(503)2284-7413, 7534-1582</td></tr></table></td></tr></table><footer><img src='./public/img/footer.jpg'  style='width: 100%;'></footer>";
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/instruquimica/public_html/sistema/resources/views/purchase/index.blade.php ENDPATH**/ ?>