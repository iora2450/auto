    ...
    $(document).ready(function() {
        var table = $('#product-data-table').DataTable( {
            ...
            rowCallback: function (row, data, index) {
                //console.log(data)
            if (parseFloat(data["qty"]) > 2) {
                $("td:eq(6)", row).addClass('badge badge-success')
            }else if(parseFloat(data["qty"]) ==1){
                $("td:eq(6)", row).addClass('badge badge-warning') 
                                    
                                }
                                else if(parseFloat(data["qty"]) ==0){
                $("td:eq(6)", row).addClass('badge badge-danger') 
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/instruquimica/public_html/sistema/resources/views/product/index.blade.php ENDPATH**/ ?>