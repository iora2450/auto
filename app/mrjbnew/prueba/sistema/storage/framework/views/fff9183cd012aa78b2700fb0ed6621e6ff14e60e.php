            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => 'quedan.store', 'method' => 'post', 'files' => false]); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select required class="form-control selectpicker" id="customer_id" name="customer_id" onchange='saveValue(this);'>
                                        ...
                                        <?php $__currentLoopData = $lims_client_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer_group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($customer_id == $customer_group->id): ?>
                                            <option value="<?php echo e($customer_group->id); ?>" selected><?php echo e($customer_group->name); ?></option>
                                            <?php endif; ?>
                                                   <?php if($customer_id != $customer_group->id): ?>
                                  ...
                                  <label>Documentos  del quedan: </label>
                                    ...
                                    <select id='documentos' name='number_invoice[]' class="selectpicker" data-live-search="true" multiple style='width: 100%'>
                                          <?php $__currentLoopData = $datos_facturas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option data-monto="<?php echo e($fact->grand_total); ?>" value="<?php echo e($fact->id); ?>"><?php echo e($fact->reference_no); ?> - <?php echo e($fact->name); ?> - $<?php echo e($fact->grand_total); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/instruquimica/public_html/sistema/resources/views/quedan/create.blade.php ENDPATH**/ ?>