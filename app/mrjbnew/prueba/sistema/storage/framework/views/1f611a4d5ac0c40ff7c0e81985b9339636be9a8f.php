                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label>Tipo de contribuyente *</strong> </label>
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nit" value="<?php echo e($lims_customer_data->nit); ?>" class="form-control">
                                </div>
                            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/instruquimica/public_html/sistema/resources/views/customer/edit.blade.php ENDPATH**/ ?>