        ...
        success: function(data) {
            ...
            $(".product-code").each(function(i) {
                if ($(this).val() == data[1]) {
                    ...
                    checkQuantity(String(qty), false);
                    flag = 1;
                }
            });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/instruquimica/public_html/sistema/resources/views/sale/create.blade.php ENDPATH**/ ?>