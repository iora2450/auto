                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type='text' class="form-control" name='credit_days'  id='credit_days' value='<?php echo $lims_quotation_data->credit_days; ?>'required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                   <div class="form-group">
                                            <label>Dias de entrega*</label>
                                            <input type='text'  class="form-control" name='delivery_time'  id='delivery_time' value='<?php echo $lims_quotation_data->delivery_time; ?>'required>
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                            <label>Validez *</label>
                                            <input type='text'  class="form-control" name='validity'  id='validity' value='<?php echo $lims_quotation_data->validity; ?>'required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Titulo*</label>
                                            <input type='text' class="form-control" name='tittle'  id='tittle' required value='<?php echo $lims_quotation_data->tittle; ?>'>
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                            <label>Nombre del vendedor *</label>
                                                ...
                                                <select id="name_seller" name="name_seller" required class="selectpicker form-control" data-live-search="true" id="customer-id_seller" data-live-search-style="begins" title="Select Biller...">
                                                <?php $__currentLoopData = $lims_biller_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $biller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                  if($lims_quotation_data->name_seller == $biller->id){               
                                                 ?>
                                                  <option value="<?php echo e($biller->id); ?>" selected><?php echo e($biller->name); ?></option>
                                             <?php } else{ ?>
                                   ...
                                   <div class="form-group">
                                            ...
                                            <input type='text'  class="form-control" name='cell_seller'  id='cell_seller' required value='<?php echo $lims_quotation_data->cell_seller; ?>'>
                                        </div>
                                    </div>
                                   </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type='text'  class="form-control" name='method_pay'  id='method_pay' value='<?php echo $lims_quotation_data->method_pay; ?>'required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                   <div class="form-group">
                                            <label>Atencion *</label>
                                            <input type='text'  class="form-control" name='attention'  id='attention' value='<?php echo $lims_quotation_data->attention; ?>'required>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/instruquimica/public_html/sistema/resources/views/quotation/edit.blade.php ENDPATH**/ ?>