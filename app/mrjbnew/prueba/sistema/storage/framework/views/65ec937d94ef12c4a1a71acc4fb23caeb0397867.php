        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-left">
                  <i style="font-size: 15px;"><label style='text-transform: uppercase;' id='referencia'></label></i>
                    <br>
                </div>
            </div>
            ...
            <table style='width: 100%'>
                <tr>
                    <td style='width: 60%'>
                         <table>
                            ...
                            <tr>
                                ...
                                <td> Cecilia Pineda; cpineda@instruquimica.com </td>
                            </tr>
                    ...
                    <td  style='width: 40%'>
                        ...
                        <table border=1>
                            <tr>
                                <td class='fondoAzul' style='width:35%'>Email:</td>
                                <td><label id='email_suppliers'></label></td>
                            </tr>

                            <tr>
                                <td class='fondoAzul' style='width:35%'>To:</td>
                                <td><label id='address_supp'></label></td>
                            </tr>
                            <tr>
...
/*Al hacer click enviare el data-id para ir a buscar a la abse de datos los datos que ya esten cargados*/
...
*/
        ...
        var htmlfooter = "<table><tr><td><table><tr><td>Ship to:<br><b>INSTRUQUIMICA S.A de C.V</b><br>Calle San Antonio Abad, pasaje valdivieso #11 San Salvador, El Salvador<br>Attn: Cecilia Pineda<br>cpineda@instruquimica.com<br>Tel:(503)2284-7413, 7534-1582</td></tr></table></td><td><table><tr><td>invoice to:<br><b>INSTRUQUIMICA S.A de C.V</b><br>Calle San Antonio Abad, pasaje valdivieso #11 San Salvador, El Salvador<br>Attn: Cecilia Pineda<br>cpineda@instruquimica.com<br>Tel:(503)2284-7413, 7534-1582</td></tr></table></td></tr></table><footer><img src='./public/img/footer.jpg'  style='width: 100%;'></footer>";
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/sofinvercs/public_html/demo/resources/views/purchase/index.blade.php ENDPATH**/ ?>