...
class CustomerController extends Controller
{
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('customers-add')){
            ...
            return view('customer.create', compact('lims_customer_group_all','lims_type_taxpayer_list'));
    ...
    public function edit($id)
    {
        ...
        if($role->hasPermissionTo('customers-edit')){
            ...
            $lims_customer_group_all = CustomerGroup::where('is_active',true)->get();
            $lims_type_taxpayer_list = Type_taxpayer::all();
            return view('customer.edit', compact('lims_customer_data','lims_customer_group_all','lims_type_taxpayer_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
