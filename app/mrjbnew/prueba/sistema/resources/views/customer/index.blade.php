                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                @endif
                                      ...
                                      <li>
                             <button type="button" data-id="{{$customer->id}}" class="contact btn btn-link" data-toggle="modal" data-target="#contactModal" ><i class="dripicons-plus"></i> Gestionar contactos</button>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          {!! Form::open(['route' => 'CustomerContact.save_contacts', 'method' => 'post', 'id'=>'formulario_contacto']) !!}
