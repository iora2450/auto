...
<section>
    ...
    <div class="container-fluid">
        <a href="{{route('quedan.create')}}" class="btn btn-info"><i class="dripicons-plus"></i>Crear quedan</a>
    </div>
    @endif
    <div class="table-responsive">
        <table id="employee-table" class="table">
            ...
            <tbody>
                @foreach($lims_quedan_list as $key=>$quedan)
               @php $cliente = \App\Customer::find($quedan->customer_id); @endphp
                <tr data-id="{{$quedan->id}}">
                   
                <td>{{$key}}</td>
                    <td>{{ $quedan->date_quedan }}</td>
                    <td>{{ $quedan->number_invoice}}</td>
                    <td>{{ $cliente->name}}</td>
                    <?php
                    $fecha1 =     date("Y-m-d");
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    ...
                                    <button type="button" data-id="{{$quedan->id}}"  data-customer_id="{{$quedan->customer_id}}"
                                     data-date_quedan="{{$quedan->date_quedan}}"  data-number_invoice="{{$quedan->number_invoice}}"  data-total="{{$quedan->total}}"  data-due_date="{{$quedan->due_date}}"   class='btn btn-link edit-btn'   data-toggle="modal"  data-target="#editModal"><i class="dripicons-document-edit"></i> Editar</button> 
                                </li>
                                @endif
                                <li class="divider"></li>
