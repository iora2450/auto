      ...
      <div class="modal-content" >
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h5 id="exampleModalLabel" class="modal-title text-left container-fluid">COTIZACIÓN DE EQUIPO Y CONSUMIBLES</h5>
                </div>
              <!--
                <div class="col-md-3">
...
<table style='width: 100%' border=1><tr><td><b>NOTA:</b></td></tr></table>
<br>
<table style='width: 100%'>
    <tr>
        <td style="width: 30%">
        <b>
<label style='text-decoration: underline;'>Condiciones comerciales:</label>
<br>
1)  Términos de pago:<br>
2)  Forma de pago:<br>
3)  Tiempo de entrega:<br>
4)  Validez de precios:<br>
    </b>
        ...
        <td style='width: 60%; '>
            30 días crédito
Cheque o transferencia bancaria a nombre de Instruquímica S.A de C.V.
4 a 8 semanas después de recibida la orden de compra. 
60 días.
...
*/
 ...
 tablita_datos= "<div class='container'><table style='width: 100%;'><tr><td style='width: 75% !important'><table border=1 STYLE='width:100%;'><tr><td class='fondoAzul' STYLE='width:25%;'>CLIENTE:</td><td STYLE='width:75%;'>"+quotation[9]+"</td></tr><tr><td class='fondoAzul'>ATENCIÓN:</td><td>"+quotation[9]+"</td></tr></table></td><td style='width: 25% !important'><table border=1 style='width: 25%; MARGIN: 0 AUTO;'><tr><td class='fondoAzul'>CLIENTE</td></tr><tr><td >"+quotation[0]+"</td></tr><tr><td class='fondoAzul'>COTIZACION</td></tr><tr><td >"+quotation[1]+"</td></tr></table></td></tr></table></div>"
