        ...
        <div style="max-width:560px;margin:0 auto">
            ...
            <div class="">
                <table  style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 80%'> <?php echo e($lims_customer_data->name); ?> </td>
            ...
            <div class="">
                <table   style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 167%' > <?php echo e($lims_customer_data->address .', '.$lims_customer_data->city); ?></td>
                        <td></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="">
                <table  style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 34%; height: 15px; font-size: 15px;'><?php echo e($lims_customer_data->nit); ?></td>
...
<?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/sale/invoice.blade.php ENDPATH**/ ?>