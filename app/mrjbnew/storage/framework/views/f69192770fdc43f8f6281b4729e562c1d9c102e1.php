                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="<?php echo e(url('return-sale/genReturn_nc/'.$return->id)); ?>" style="text-decoration: none;">
                                        <button type="button" class="btn btn-link btn-sm">
                                            <i class="fa fa-print"></i> NC
                                        </button>
                                    </a>                                        
                                </li>     
                                <li>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/return/index.blade.php ENDPATH**/ ?>