...
<div class="alert alert-danger alert-dismissible text-center">
    ...
    <?php echo e('No Data exist between this date range!'); ?>
...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">Reporte detallado de Compras</h3>
            </div>
            <?php echo Form::open(['route' => 'report.PurchasesdayReport', 'method' => 'get']); ?>
    ...
    <div class="table-responsive mb-4" id="div_print">
        ...
        <center>
            ...
            <b>MR. J&B INVERSIONES DEL CIELO, S.A. DE C.V.</b><br><b>Detalle de compras por numero de comprobante</b><br>Del <?php echo e(\Carbon\Carbon::parse($start_date)->format('d/m/Y')); ?> al <?php echo e(\Carbon\Carbon::parse($end_date)->format('d/m/Y')); ?> 
            <br>
        ...
        <table id="report-table" class="table" style='line-height: 1.1;'>
            ...
            <tfoot>
                ...
                <td class="text-right" colspan="1">$<?php echo e(number_format($sperce,2)); ?></td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/report/Purchases_daily_report.blade.php ENDPATH**/ ?>