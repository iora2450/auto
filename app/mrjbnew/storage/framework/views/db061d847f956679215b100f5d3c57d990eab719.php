                    ...
                    <div class="card-body">
						...
						<div class="table-responsive">
						    <table class="table table-bordered permission-table">
						        ...
						        <tr>
						            <td><?php echo e(trans('file.Type Documents')); ?></td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("typedocument-index", $all_permission)): ?>
								                <input type="checkbox" value="1" id="typedocument-index" name="typedocument-index" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="typedocument-index" name="typedocument-index">
								                <?php endif; ?>
								                <label for="typedocument-index"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("typedocument-add", $all_permission)): ?>
								                <input type="checkbox" value="1" id="typedocument-add" name="typedocument-add" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="typedocument-add" name="typedocument-add">
								                <?php endif; ?>
								                <label for="typedocument-add"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("typedocument-edit", $all_permission)): ?>
								                <input type="checkbox" value="1" id="typedocument-edit" name="typedocument-edit" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="typedocument-edit" name="typedocument-edit">
								                <?php endif; ?>
								                <label for="typedocument-edit"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("typedocument-delete", $all_permission)): ?>
								                <input type="checkbox" value="1" id="typedocument-delete" name="typedocument-delete" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="typedocument-delete" name="typedocument-delete">
								                <?php endif; ?>
								                <label for="typedocument-delete"></label>
								            </div>
						            	</div>
						            </td>
						        </tr>
						        ...
						        <tr>
						            <td><?php echo e(trans('file.Boxcuts')); ?></td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("boxcuts-index", $all_permission)): ?>
								                <input type="checkbox" value="1" id="boxcuts-index" name="boxcuts-index" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="boxcuts-index" name="boxcuts-index">
								                <?php endif; ?>
								                <label for="boxcuts-index"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("boxcuts-add", $all_permission)): ?>
								                <input type="checkbox" value="1" id="boxcuts-add" name="boxcuts-add" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="boxcuts-add" name="boxcuts-add">
								                <?php endif; ?>
								                <label for="boxcuts-add"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("boxcuts-edit", $all_permission)): ?>
								                <input type="checkbox" value="1" id="boxcuts-edit" name="boxcuts-edit" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="boxcuts-edit" name="boxcuts-edit">
								                <?php endif; ?>
								                <label for="boxcuts-edit"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("boxcuts-delete", $all_permission)): ?>
								                <input type="checkbox" value="1" id="boxcuts-delete" name="boxcuts-delete" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="boxcuts-delete" name="boxcuts-delete">
								                <?php endif; ?>
								                <label for="boxcuts-delete"></label>
								            </div>
						            	</div>
						            </td> 
						        </tr>
						        ...
						        <tr>
						            <td><?php echo e(trans('file.Quedan Purchase')); ?></td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("quedanpurchase-index", $all_permission)): ?>
								                	<input type="checkbox" value="1" id="quedanpurchase-index" name="quedanpurchase-index" checked>
								                <?php else: ?>
								                	<input type="checkbox" value="1" id="quedanpurchase-index" name="quedanpurchase-index">
								                <?php endif; ?>
								                <label for="quedanpurchase-index"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("quedanpurchase-add", $all_permission)): ?>
								                <input type="checkbox" value="1" id="quedanpurchase-add" name="quedanpurchase-add" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="quedanpurchase-add" name="quedanpurchase-add">
								                <?php endif; ?>
								                <label for="quedanpurchase-add"></label>
								            </div>
						            	</div>
						            </td>
						        </tr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/role/permission.blade.php ENDPATH**/ ?>