                    ...
                    <div class="">
                        <table   style='min-height:10px; max-height:10px;'>
                            <tr>
                                ...
                                <td style='width: 87%'>Fecha estimada de Pago: <?php echo e(\Carbon\Carbon::parse($v->created_at)->format('d/m/Y')); ?> </td>
                            </tr>
                        </table>
                    </div>
...
</html><?php /**PATH /home2/mrjbinve/public_html/sistema1/resources/views/quedan_purchase/pdf.blade.php ENDPATH**/ ?>