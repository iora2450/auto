...
<body> 
    ...
    <div id="receipt-data">
        ...
        <div id=tabla1>
            ...
            <table  style='min-height:10px; max-height:10px;'>
                <tr>
                    <td>NIT: 06143009941026</td>                        
                    <td style='width: 70%;'>Nombre, denominación o razón social: BOLSA DE PRODUCTOS DE EL SALVADOR, S.A. DE C.V.</td>
                </tr>    
            </table>  
        </div>
        <?php endif; ?>
        ...
        <div class="container-fluid" id="tabla1">
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td id=cabtab3 style='width: 67.8%;'>Valor en letras: <?php echo e($todo); ?></td>
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 110%; font-size: 9px; background-color: red;'>Nombre recibe:</td>
                        <td style='width: 200%; text-align: left; padding-left: 2px; padding-right: 40px;'>No. Documento:</td>
                        <td style='text-align: left; padding-right: 144px;'>Monto Total de la Operación:</td>
                        <td style='width:8%; text-align: right; padding-left: 20px; padding-right: 1px; background-color: blue;'>
...
<?php /**PATH C:\xampp7433\htdocs\mrjb\resources\views/sale/efact.blade.php ENDPATH**/ ?>