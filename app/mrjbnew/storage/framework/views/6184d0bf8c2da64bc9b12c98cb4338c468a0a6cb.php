    ...
    <div id="receipt-data">
        ...
        <div style="max-width:600px;margin:0 auto">
            ...
            <div class="">
                <table  style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 75%; padding-left: 60px;'><?php echo e($lims_customer_data->state); ?> </td>
                ...
                <table  style='min-height:10px; max-height:10px;'>
                    <tr>
                        <?php if($lims_sale_data->payment_method=="contado"): ?>
                            <td style='width: 70%; padding-left: 65px;'>Contado</td>
                        <?php else: ?>
                            <td style='width: 70%; padding-left: 65px;'>Crédito</td>
                        <?php endif; ?>
                        <td style='max-width:700px; text-align: left;'>
                            <small style="font-size: 7.5px; padding-left: 2px; max-width: 70%;">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $lims_product_sale_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_sale_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td style='width: 75%; padding-left: 10px;'><?php
                                    if($licitacion !="off"){
                                        echo $description;
                                    }else{
                                        echo $product_name;
                        ...
                        <tr>
                            <?php if($lims_customer_data->type_taxpayer_id==4): ?>
                                ...
                                <td style='width:8%; text-align: right; padding-left: 150px; padding-right: 55px;'>
                                    <?php echo e(number_format((float)$lims_sale_data->grand_total / 1.13, 2, '.', '')); ?></td>
                                <td style='width:8%;'></td>
                            <?php else: ?>
                                <td style='width: 3%;'></td>
                                <td style='width: 5%;'></td>
                                ...
                                <td style='width:8%; text-align: right; padding-left: 200px'>
                                    <?php echo e(number_format((float)$lims_sale_data->grand_total / 1.13, 2, '.', '')); ?>
...
<?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/sale/invoice_ccf.blade.php ENDPATH**/ ?>