  ...
  <!--Manejo de tipos de documentos--->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required name="document_id" id="document_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select document...">
                                                ...
                                                <?php
                                                  if($document->id== $lims_sale_data->document_id ){
                                                    ?>
                                               <option selected value="<?php echo e($document->id); ?>"><?php echo e($document->documento); ?></option>
                                                 <?php
                                                  }else{
                                                ?>
                                  ...
                                  <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="resolucion" id="resolucion" class="form-control" value='<?php echo e($lims_sale_data->resolucion); ?>'/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="serie" id="serie" class="form-control"  value='<?php echo e($lims_sale_data->serie); ?>' />
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php
                                              if($lims_sale_data->licitacion=="on"){
                                            ?>
                                             Si
                                        <input type='radio' name='licitacion' value='on' checked="true">
                                         no 
                                        ...
                                        <input type='radio' name='licitacion' value='on'>
                                         No 
                                         <input type="radio" name='licitacion' value='off' checked="true">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="hidden" class="description" name="description[]" value="<?php echo e($product_sale->description); ?>">
...
function edit(){
    ...
    var descrip = $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.descripcion').val();

    $('input[name="edit_qty"]').val(qty);

    $('textarea[name="edit_description"]').val(descrip);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/sale/edit.blade.php ENDPATH**/ ?>