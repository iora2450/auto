...
<section>
    <div class="container-fluid">
      <?php if(in_array("boxcuts-add", $all_permission)): ?>
            <a href="<?php echo e(route('boxcuts.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add Box Cut')); ?></a>
      <?php endif; ?>
    </div>
    <div class="table-responsive">
        <table id="boxcut-table" class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <?php $__currentLoopData = $lims_box_cut_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$boxcut): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $warehouse = DB::table('warehouses')->find($boxcut->warehouse_id);
                ?>
                <tr data-id="<?php echo e($boxcut->id); ?>">
                    <td><?php echo e($key); ?></td>
                    <td><?php echo e(\Carbon\Carbon::parse($boxcut->created_at)->format('d/m/Y')); ?></td>
                    <td><?php echo e($boxcut->reference_no); ?></td>
                    <td><?php echo e($warehouse->name); ?></td>
                    <td><?php echo e($boxcut->note); ?></td>
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li><button type="button" data-id="<?php echo e($boxcut->id); ?>" class="open-Editbox_cutDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></button></li>
                                <?php endif; ?>
                                <?php if(in_array("boxcuts-delete", $all_permission)): ?>
                                <li class="divider"></li>
                                <?php echo e(Form::open(['route' => ['boxcuts.destroy', $boxcut->id], 'method' => 'DELETE'] )); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                <?php echo Form::open(['route' => ['tickets.update', 1], 'method' => 'put']); ?>
...
<script type="text/javascript">
    ...
    $("ul#boxcut #boxc-list-menu").addClass("active");
    ...
    $(document).ready(function() {
        $(document).on('click', 'button.open-Editbox_cutDialog', function() {
            var url = "expenses/";
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/boxcut/index.blade.php ENDPATH**/ ?>