			...
			<div class="col-md-4 offset-md-4">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2"><?php echo e(trans('file.Sent')); ?> <span class="float-right">- <?php echo e(number_format((float)($payment_sent_cash), 2, '.', '')); ?></span></p>
						<p class="mt-2"><?php echo e(trans('file.Sale Return')); ?> <span class="float-right">- <?php echo e(number_format((float)$return[0]->grand_total, 2, '.', '')); ?></span></p>
						<p class="mt-2"><?php echo e(trans('file.Purchase Return')); ?> <span class="float-right"> <?php echo e(number_format((float)$purchase_return[0]->grand_total, 2, '.', '')); ?></span></p>
						...
						<p class="mt-2"><?php echo e(trans('file.In Hand')); ?> <span class="float-right"><?php echo e(number_format((float)($payment_recieved - $payment_sent_cash - $return[0]->grand_total + $purchase_return[0]->grand_total - $expense - $payroll), 2, '.', '')); ?></span></p>
					</div>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/report/profit_loss.blade.php ENDPATH**/ ?>