...
<script type="text/javascript">
    ...
    */
    ...
    function purchaseDetails(purchase){
        var htmltext = '<strong ><?php echo e(trans("file.Purchase Number")); ?>: </strong>'+purchase[34]+'<br><strong><?php echo e(trans("file.Date")); ?>: </strong>'+purchase[0]+'<br><strong><?php echo e(trans("file.Invoice")); ?>: </strong>'+purchase[36]+'<br><strong><?php echo e(trans("file.Purchase Status")); ?>: </strong>'+purchase[2]+'<br><br><div class="row"><div class="col-md-6"><strong><?php echo e(trans("file.From")); ?>:</strong><br>'+"MR. JB INVERSIONES DEL CIELO, S.A. DE C.V."+'<br>'+'<?php echo e(trans("file.To Warehouse")); ?>: '+purchase[4]+'<br>'+purchase[6]+'</div><div class="col-md-6"><div class="float-right"><strong><?php echo e(trans("file.To")); ?>:</strong><br>'+purchase[7]+'<br>'+purchase[9]+'<br>'+purchase[10]+'<br>'+purchase[11]+'<br>'+purchase[12]+'</div></div></div>';
        ...
        $.get('purchases/product_purchase/' + purchase[3], function(data){
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=4><strong><?php echo e(trans("file.SubTotal")); ?>:</strong></td>';
            cols += '<td>' + '</td>';
            cols += '<td>' + '</td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=4><strong><?php echo e(trans("file.Tax")); ?>:</strong></td>';
            cols += '<td>' +  '</td>';
            cols += '<td>' +  '</td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong><?php echo e(trans("file.Percepcion Tax")); ?>:</strong></td>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/purchase/index.blade.php ENDPATH**/ ?>