...
<section>
    ...
    <div class="container-fluid">
        <a href="<?php echo e(route('quedan_purchase.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i><?php echo e(trans('file.Add Quedan')); ?></a>
    </div>
    <?php endif; ?>
        ...
        <table id="employee-table" class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $lims_quedan_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$quedan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $cliente = \App\Supplier::find($quedan->supplier_id); ?>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <li>
                                        <a href="<?php echo e(url('quedan_purchase/genQuedan/'.$quedan->id)); ?>" target="_blank" style="text-decoration: none;">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/sistema1/resources/views/quedan_purchase/index.blade.php ENDPATH**/ ?>