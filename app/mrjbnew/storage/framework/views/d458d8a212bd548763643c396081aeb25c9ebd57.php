                            ...
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select required name="type_purchase" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Seleccione tipo de compra ">
                                                <?php
                                                 $type_purchase= $lims_purchase_data->type_purchase;
                                                 $selected_1= ""; 
                                                 $selected_2= ""; 
                                                 if($type_purchase==1){
                                                  $selected_1="selected";
                                                ...
                                                ?>
                                        <option value='1' <?php echo $selected_1; ?> >Orden de compra</option>
                                        <option value='2' <?php echo $selected_2; ?> >Garantia</option>
   ...
   <div class="row">
                                 ...
                                 <div class="form-group">
                                            ...
                                            <select id="customer_id" name="customer_id" required class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select customer...">
                                                ...
                                                <?php
                                                 $selected =""; 
                                                  if($customer->id== $lims_purchase_data->customer_id){
                                                    $selected ="selected";
                                                  }else{
                                                    $selected=""; 
                                                  }
                                                ?>
                                                <option value="<?php echo e($customer->id); ?>" <?php echo $selected; ?> > <?php echo e($customer->name . ' (' . $customer->phone_number . ')'); ?></option>
                                 ...
                                 <div class="col-md-4">
                                   <div class="form-group">
                                            ...
                                            value="<?php echo $lims_purchase_data->serial;?>"
                                            >
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-md-4">
                                   <div class="form-group">
                                            <label>Chemistry Application*</label>
                                            <input type="text" class="form-control" name="chemistry_application" id="chemistry_application" required="true" value="<?php echo $lims_purchase_data->chemistry_application;?>">
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email_suppliers" id="email_suppliers" required="" value="<?php echo $lims_purchase_data->email_suppliers;?>">
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                            <label>terms*</label>
                                            <input type="text" class="form-control" name="terms" id="terms" required="" value="<?php echo $lims_purchase_data->terms;?>">
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="hidden" class="net_unit_cost" name="net_unit_cost[]" value="<?php echo e($product_purchase->net_unit_cost); ?>" />
                                                         ...
                                                         <input type="hidden" class="net_unit_cost_original" name="net_unit_cost_original[]" value="<?php echo e($product_purchase->net_unit_cost_original); ?>" />
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag){
                ...
                cols += '<input type="hidden" class="net_unit_cost_original" name="net_unit_cost_original[]" />';
...
function calculateGrandTotal() {
    ...
    item = ++item + '(' + total_qty + ')';
    order_tax = ((subtotal/1.13) - order_discount) * (order_tax / 100);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/purchase/edit.blade.php ENDPATH**/ ?>