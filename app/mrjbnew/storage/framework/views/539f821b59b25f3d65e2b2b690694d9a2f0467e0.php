                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="email_purchase" name="email_purchase" placeholder="example@example.com" required class="form-control">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="name_purchase" name="name_purchase" placeholder="Name purchase" required class="form-control">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/user/create.blade.php ENDPATH**/ ?>