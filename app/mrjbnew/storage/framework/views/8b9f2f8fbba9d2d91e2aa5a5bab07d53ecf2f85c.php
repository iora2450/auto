...
<body>
    ...
    <div id="receipt-data">
        ...
        <div style="max-width:560px;margin:0 auto">
            ...
            <br>
            <!--Formato a  linea 2: (Direccion) -->
            <div class="">
                <table   style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 77%' > <?php echo e($lims_customer_data->address .', '.$lims_customer_data->city); ?></td>
                    </tr>
                </table>
            </div>
            <br>
            <!--Formato a  linea 3: (Registro y Forma de Pago) -->
            <div class="">
                <table  style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 34%; padding-left: 105px;'><?php echo e($lims_customer_data->nit); ?>  </td>
                ...
                <table>
                    <tbody>
                        ...
                        <?php $__currentLoopData = $lims_product_sale_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_sale_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                <td  style='width: 1%;'></td>
                                <td  style='width: 5%; float:left; padding-left: 15px;'>
                                    <?php echo e(number_format((float) $product_sale_data->qty, 2, '.', '')); ?>

                                </td>
                                <td style='width: 62%; padding-left: 15px;'><?php
                                    if($licitacion !="off"){
                                        echo $description;
                                    }else{
                                        echo $product_name;
                            ...
                            <tr>
                                <td style='width: 1%;'></td>
                                <td style='width: 5%; float:left; padding-left: 15px;'></td>
                                <td style='width: 62%; padding-left: 15px;'>
                                    <?php
                                        if($licitacion !="on"){
                                            echo $description;
                                    }
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td style='width:8%;'></td>
                            <td style='width:8%;'></td>
                            <td style='width:8%; text-align: right; padding-left: 400px'></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table>
                    <tbody>
                        <tr>
                            <td  style='width: 3%;'></td>
                            <td  style='width: 5%;'></td>
                            <td style='width: 60%; font-size: 9px; padding-left: 20px;' id='letras'></td>
                            <td style='width:8%;'></td>
                            <td style='width:8%;'></td>
                            <td style='width:8%;'></td>
...
<?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/sale/invoice_export.blade.php ENDPATH**/ ?>