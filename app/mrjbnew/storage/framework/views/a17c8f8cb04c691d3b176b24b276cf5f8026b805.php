                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="chemistry_application" id="chemistry_application" required="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email_suppliers" id="email_suppliers" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>ETerms*</label>
                                            <input type="text" class="form-control" name="terms" id="terms" required="true" value="45 dias">
                                        </div>
                                    </div>

                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Invoice')); ?>*</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <span>
                                           <strong><?php echo e($errors->first('po_number')); ?></strong>
                                        </span>
                                        <?php endif; ?>
                                    </div>
...
$("table.order-list").on("click", ".edit-product", function() {
    ...
    unitConversion();
    $('input[name="edit_unit_cost"]').val(row_product_cost.toFixed(4));
...
function calculateRowProductData(quantity) {
    ...
    if (tax_method[rowindex] == 1) {
        ...
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(5)').text(net_unit_cost.toFixed(4));
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_cost').val(net_unit_cost.toFixed(4));
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/sistema/resources/views/purchase/create.blade.php ENDPATH**/ ?>