...
return [
	...
	'Add Type Document' => 'Add Type Document',
	...
	"Percepcion Tax" => "Percepcion Tax",
	"SubTotal" => "SubTotal",
	"Box Cut" => "Box Cut",
	"Add Type of Currency" => "Add Type of Currency",
	"Update Type Currency" => "Update Type Currency",
	"Type Currency" => "Type Currency",
	"Box Cut List" => "Box Cut List",
	"Add Box Cut" => "Add Box Cut",
	"Box Cut Report" => "Box Cut Report",
	"Quedan List" => "Quedan List", 
	"Add Quedan" => "Add Quedan",
	"Date quedan" => "Date quedan",
	"Documents of quedan" => "Documents of quedan",
	"retentions" => "retentions",
	"Purchase retention" => "Purchase retention",
	"Excluded" => "Excluded",
	'Add Excluded' => 'Add Excluded',
	'Rent Discount' => 'Rent Discount',
	'Documents of retention' => 'Documents of retention',
	'Excludes List' => 'Excludes List',
	'Add Excludes' => 'Add Excludes',
	'Dui' => 'Dui',
	'Municipality' => 'Municipality',
	'Commercial Name' => 'Commercial Name',
	'Type of Taxpayer' => 'Type of Taxpayer',
	'Generate CCF' => 'Generate CCF',
	'Third' => 'Third',
	'No' => 'No',
	'Yes' => 'Yes',
	'Tax Book' => 'Tax Book',
