        ...
        <div class="form-group">
            ...
            <div class="controls">
                <div class="input-prepend input-group">
                    <input type="date" name="fecha_ini" class="form-control" placeholder="{{ __('Enter date') }}">
                </div>
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <div class="input-group">
                    <input type="date" name="fecha_fin" class="form-control" placeholder="{{ __('Enter date') }}">
                </div>
