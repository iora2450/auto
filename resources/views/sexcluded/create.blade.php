            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'sexcluded.store', 'method' => 'post', 'files' => true, 'id' => 'purchase-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.excluded')}} *</label>
                                            <select id="excluded_id" name="excluded_id" required class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select customer...">
                                                @foreach($lims_excluded_list as $excluded)
                                                    <option value="{{$excluded->id}}">{{$excluded->name . ' (' . $excluded->phone_number . ')'}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>                   
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label>{{trans('file.Rent Discount')}}</label>
