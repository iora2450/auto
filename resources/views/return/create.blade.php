    ...
    <div class="modal-dialog modal-lg" style="width: 110%;"> <!-- Aumentar en un 10% -->
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="searchForm" action="{{ route('sale.search_invoices') }}" method="GET" class="search-form">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select required name="document_id" id="document_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select document.">
                                                <?php $deposit = []; ?>
                                                @foreach($lims_documents_list as $document)
                                                    <?php $deposit[$document->id] = $document->documento; ?>
                                                    <option value="{{$document->id}}">{{$document->documento}}</option>
                                                @endforeach
                                            </select> 
                                        </div>                        
                                    </div>
