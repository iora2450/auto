...
<section>
    ...
    <div class="container-fluid">
        <a href="{{route('quedan_purchase.create')}}" class="btn btn-info"><i class="dripicons-plus"></i>{{trans('file.Add Quedan')}}</a>
    </div>
    @endif
        ...
        <table id="employee-table" class="table">
            ...
            <tbody>
                @foreach($lims_quedan_list as $key=>$quedan)
                    @php $cliente = \App\Supplier::find($quedan->supplier_id); @endphp
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <li>
                                        <a href="{{ url('quedan_purchase/genQuedan/'.$quedan->id)}}" target="_blank" style="text-decoration: none;">
