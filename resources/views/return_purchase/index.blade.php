                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a href="{{ route('return-purchase.download', $return->id) }}" class="btn btn-link">
                                        <i class="dripicons-download"></i>
                                        {{ trans('file.Download') }}
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('return-purchase.document', $return->id) }}" class="btn btn-link" target="_blank" rel="noopener noreferrer">
