...
<section>
    <div class="container-fluid">
        ...
        <a href="{{route('excluded.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Excluded')}}</a>&nbsp;
        @endif
    </div>
        ...
        <table id="biller-table" class="table">
            <thead>
                <tr>
                    ...
                    <th>{{trans('file.Dui')}}</th>
                    <th>{{trans('file.Nit')}}</th>
            ...
            <tbody>
                @foreach($lims_excluded_all as $key=>$biller)
                <tr data-id="{{$biller->id}}">
                    ...
                    <td>{{ $biller->phone}}</td>
                    <td>{{ $biller->address}}
                        @if($biller->state_id){{ ', '.$biller->estado->name}}@endif
                        @if($biller->municipality_id){{ ', '.$biller->municipio->name}}@endif
                    </td> 
                    @if($biller->is_active)
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a href="{{ route('excluded.edit', $biller->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a> 
                                </li>
                                @endif
                                <li class="divider"></li>
