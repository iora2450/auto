                        ...
                        {!! Form::open(['route' => ['user.update', $lims_user_data->id], 'method' => 'put', 'files' => true]) !!}
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mt-3">
                                        <label><strong>{{trans('file.Email Purchase')}} *</strong></label>
                                        <input type="email_purchase" name="email_purchase" placeholder="example@example.com" required class="form-control" value="{{$lims_user_data->email_purchase}}">
                                        @if($errors->has('email_purchase'))
                                       <span>
                                           <strong>{{ $errors->first('email_purchase') }}</strong>
                                        </span>
                                        @endif
                                    </div>
                                    <div class="form-group mt-3">
                                        <label><strong>{{trans('file.Name Purchase')}} *</strong></label>
                                        <input type="name_purchase" name="name_purchase" placeholder="Name purchase" required class="form-control" value="{{$lims_user_data->name_purchase}}">
                                        @if($errors->has('name_purchase'))
                                       <span>
                                           <strong>{{ $errors->first('name_purchase') }}</strong>
                                        </span>
                                        @endif
                                    </div>
                                </div>                              
