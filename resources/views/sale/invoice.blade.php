...
<body>
    ...
    <div id="receipt-data">
        ...
        <div style="max-width:560px;margin:0 auto">
            ...
            <div class="">
                <table  style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 80%'> {{$lims_customer_data->name}} </td>
                        <td style='width: 77%; font-size: 10.5px;'>
            ...
            <div class="">
                <table   style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 167%' > {{$lims_customer_data->address .', '.$lims_customer_data->city}}</td>
                        <td></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="">
                <table  style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 34%; height: 15px; font-size: 15px;'>{{$lims_customer_data->nit}}</td>
                        @if($lims_sale_data->payment_method=="contado")
                            <td style='width: 2%'>Contado</td>
                        @else
                            <td style='width: 10%'>Crédito</td>
                        @endif
                    </tr>
                </table>
            </div>
                        ...
                        @foreach($lims_product_sale_data as $product_sale_data)
                            ...
                            <tr>
                                ...
                                @if($lims_customer_data->type_taxpayer_id==4)
                                    <td style='width:8%; text-align: right; padding-right: 37px;'>
        ...
        <div style="max-width:700px; margin-bottom: 0 auto; margin-right: 0 auto; margin-top:30px; margin-left: 40px;">
            <div class="">
                <table>
                    <tbody>
                        <tr>
                            @if($lims_customer_data->type_taxpayer_id==4)
                                ...
                                <td style='width:8%; text-align: right; padding-left: 150px; padding-right: 55px;'>{{number_format((float)$lims_sale_data->grand_total, 2, '.', '')}}</td>
                                <td style='width:8%;'></td>
                            @else
                                <td style='width: 3%;'></td>
                                <td style='width: 5%;'></td>
                                ...
                                <td style='width:8%;'></td>
                                <td style='width:8%;'></td>
                                <td style='width:8%; text-align: right; padding-left: 200px'>{{number_format((float)$lims_sale_data->grand_total, 2, '.', '')}}</td>
                            @endif
                        </tr>
                    </tbody>
                </table>
            ...
            <!--Formato a linea 6 venta no sujeta-->
            <div class="">
                <table>
                    <tbody>
                        <tr>
            ...
            <!--Formato a linea 7 venta exenta-->
            <div class="">
                <table>
                    <tbody>
                        <tr>
            ...
            <!--Formato a linea 10 venta total-->
            <div class="">
                <table>
                    <tbody>
                        <tr>
