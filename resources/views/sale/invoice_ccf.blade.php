    ...
    <div id="receipt-data">
        ...
        <div style="max-width:600px;margin:0 auto">
            ...
            <div class="">
                <table  style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 75%; padding-left: 60px;'>{{$lims_customer_data->state}} </td>
                        ...
                        <tr>
                            @if($lims_customer_data->type_taxpayer_id==4)
                                ...
                                <td style='width:8%; text-align: right; padding-left: 150px; padding-right: 55px;'>
                                    {{number_format((float)$lims_sale_data->grand_total / 1.13, 2, '.', '')}}</td>
                                <td style='width:8%;'></td>
                            @else
                                <td style='width: 3%;'></td>
                                <td style='width: 5%;'></td>
                                ...
                                <td style='width:8%; text-align: right; padding-left: 200px'>
                                    {{number_format((float)$lims_sale_data->grand_total / 1.13, 2, '.', '')}}
                                </td>
                            @endif
                        </tr>
                    </tbody>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td style='width:8%;'></td>
                            <td style='width:8%;'></td>
                            <td style='width:8%; text-align: right;'>{{number_format((float)$lims_sale_data->grand_total, 2, '.', '')}}
