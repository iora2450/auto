                    ...
                    <div class="col-4">
                        <div class="textContri" style="margin-top: 40px; padding-left: 150px;">
                            ...
                            <div class="row dte">                            
                                ...
                                <div class="col-6">
                                    <p class="dte" style="margin-left: 3px;">Fecha de emisión: {{ \Carbon\Carbon::parse($lims_sale_data->created_at)->format('dmY') }}</p>
                                </div>                        
                            </div>
                            <br>
                            <div class="row dte">                            
    ...
    <div id="receipt-data">
        ...
        <div class="container-fluid" id="tabla1">
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 70%;'>Act. Económica: {{ $lims_customer_data->gire->name }}</td>
            ...
            <div class="">
                <table   style='min-height:10px; max-height:10px;'>
                    <tr>
                        ...
                        <td>Telefono: {{ $lims_customer_data->phone_number }}</td>
                    </tr>
                </table>
            </div>
...
<div class="container-fluid" id="tabla1">
    ...
    <tr>
        ...
        <th style="width:3px;">Desc. por Item</th>
        <th style="width:3px; text-align: left;">Montos no afectos</th>
    ...
    @endif
            ...
            <td style="width:3px;">{{ number_format((float)$is_exempt, 2, '.', '') }}</td>
            <td style="width:3px;"></td>
            <td style="width:3px; "></td>
            <td style="width:3px; text-align: right;">
                {{ number_format((float)$gravado, 2, '.', '') }}
            </td>
        </tr>
    @endforeach
</table>
...
@foreach($lims_product_sale_data as $product_sale_data)
    @if($product_sale_data->tax == 0)
        @php $ventas_exentas += $product_sale_data->total; @endphp
    @else
        @php $ventas_gravadas += $product_sale_data->total / 1.13; @endphp
    @endif
@endforeach
        <div class="container-fluid" id="tabla1">
            ...
            {{ number_format((float)$ventas_exentas, 2, '.', ',') }}
            </td>
            <td style='text-align: right;'>
           0.00
            </td>
            <td style='width:8%; text-align: right; padding-left: 20px; padding-right: 1px;'>
                ...
                <!--{{ number_format((float)($ventas_exentas + $ventas_gravadas), 2, '.', ',') }} -->
            </td>
        </tr>
                </table>
            </div>
            ...
            <div>
                <div class="">
                    ...
                    <br>
                    OBSERVACIONES:
                    {{ $lims_sale_data->sale_note ?? 'Sin observaciones' }}
                    <br>
                    Valor en letras: {{ $todo }}
                </td>
                            <td>
                                Total descuentos: 
                            </td>
                            <td style='width:8%; text-align: right; padding-left: 20px; padding-right: 1px;'>
                                {{number_format((float)$lims_sale_data->discount / 1.13, 2, '.', ',')}} 
                            </td>
                        </tr>
                    </table>
                </div>    
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 110%; font-size: 9px;'>Nombre entrega: {{ $userName }}</td>
                        <td style='width: 80%; text-align: left; padding-left: 2px; padding-right: 40px;'>No. Documento: {{ $userNit }}</td>
                        @if($lims_sale_data->discount > 0)
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        ...
                        <td style='width:8%; text-align: right; padding-left: 20px; padding-right: 1px;'>
                            {{number_format((float)$lims_sale_data->grand_total-$ventas_exentas, 2, '.', ',')}}
                        </td>
                    </tr>
                </table>
            </div>
