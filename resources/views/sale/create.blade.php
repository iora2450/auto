            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'sales.store', 'method' => 'post', 'files' => true, 'class' => 'payment-form', 'onsubmit' => 'handleSubmit()']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="text" name="aduana" class="form-control"/>
                                ...
                                <div class="form-group"> 
                                    {!! Form::submit(trans('file.submit'), ['class' => 'btn btn-primary', 'id' => 'submit-button']) !!}
                                </div>
