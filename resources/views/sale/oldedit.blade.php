  ...
  <!--Manejo de tipos de documentos--->
                                            ...
                                            <select required name="document_id" id="document_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select document...">
                                                ...
                                                <?php
                                                  if($document->id== $lims_sale_data->document_id ){
                                                    ?>
                                               <option selected value="{{$document->id}}">{{$document->documento}}</option>
                                                 <?php
                                                  }else{
                                                ?>
                                  ...
                                  <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="resolucion" id="resolucion" class="form-control" value='{{ $lims_sale_data->resolucion }}'/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="serie" id="serie" class="form-control"  value='{{ $lims_sale_data->serie }}' />
                                        </div>
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="hidden" class="description" name="description[]" value="{{$product_sale->description}}">
