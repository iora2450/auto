    ...
    <div id="receipt-data">
        ...
        <div class="container-fluid" id="tabla1">
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td id=cabtab3 style='width: 67.8%;'>Valor en letras: {{ $data['todo'] }}</td>
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 110%; font-size: 9px;'>Nombre entrega: {{ $data['userName'] }}</td>
                        <td style='width: 80%; text-align: left; padding-left: 2px; padding-right: 40px;'>No. Documento: {{ $data['userNit'] }}</td>
                        @if($lims_sale_data->discount > 0)
