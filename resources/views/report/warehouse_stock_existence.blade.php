...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            ...
            {!! Form::open(['route' => 'report.warehouseStockReport', 'method' => 'get']) !!}
            <div class="row mb-3">
        ...
        <div role="tabpanel" class="tab-pane fade show active" id="warehouse-sale">
            <div class="table-responsive mb-4">
                ...
                <table id="report-table" class="table table-hover">
                    ...
                    <tbody>
                        @foreach($lims_product_warehouse as $key)
                            <tr>
                                <?php
                                ...
                                <td style='text-align: right;'>
                                    {{number_format((float)($key->cost), 2, '.', ',')}}
                                </td>
                                <td style='text-align: right;'>
                                    {{number_format((float)($key->total), 2, '.', ',')}}
                                </td>
                                <td></td>            
                            </tr>
                        @endforeach
                    ...
                    <tfoot>
                        ...
                        <th>Total</th>
                        <th></th>
                        <th>{{number_format((float)($total_product), 4, '.', ',')}}</th>
                        <th></th>
                        <th style='text-align: right;'>{{number_format((float)($total_total), 2, '.', ',')}}</th>
                    </tfoot>
                </table>
            </div>
        </div>
