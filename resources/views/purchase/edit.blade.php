   ...
   <div class="row">
                                 ...
                                 <div class="form-group">
                                            ...
                                            <select id="customer_id" name="customer_id" required class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select customer...">
                                                ...
                                                ?>
                                                <option value="{{$customer->id}}" <?php echo $selected; ?> > {{$customer->name . ' (' . $customer->phone_number . ')'}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="hidden" class="net_unit_cost" name="net_unit_cost[]" value="{{$product_purchase->net_unit_cost}}" />
                                                         ...
                                                         <input type="hidden" class="net_unit_cost_original" name="net_unit_cost_original[]" value="{{$product_purchase->net_unit_cost_original}}" />
