            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => 'sexcluded.store', 'method' => 'post', 'files' => true, 'id' => 'purchase-form']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.excluded')); ?> *</label>
                                            <select id="excluded_id" name="excluded_id" required class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select customer...">
                                                <?php $__currentLoopData = $lims_excluded_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $excluded): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($excluded->id); ?>"><?php echo e($excluded->name . ' (' . $excluded->phone_number . ')'); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>                   
                                        ...
                                        <div class="col-md-6" style="display: none">
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-control">
                                                    <option selected value="1"><?php echo e(trans('file.Recieved')); ?></option>                                                    
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="edit_unit_cost" class="form-control" step="any" onkeyup="add()";>
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.Rent Discount')); ?></label>
                            <input type="number" name="edit_discount" class="form-control" step="any" value="10" disabled>
                        </div>
                        <?php
                $tax_name_all[] = 'No Tax';
                $tax_rate_all[] = 0;
    ...
    $("#document_id").change(function(){
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                $("#po_number").val(data[0]["correlativo"])
            }
        });
    })
...
$('button[name="update_btn"]').on("click", function() {
    ...
    //var edit_discount = $('input[name="edit_unit_cost"]').val() * $('input[name="edit_discount"]').val() / 100;
    ...
    product_discount[rowindex] = $('input[name="edit_unit_cost"]').val() * $('input[name="edit_discount"]').val() / 100;
...
function calculateRowProductData(quantity) {
    ...
    if (tax_method[rowindex] == 1) {
        ...
        var sub_total = (net_unit_cost * quantity) - tax - product_discount[rowindex];
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/factue/resources/views/sexcluded/create.blade.php ENDPATH**/ ?>