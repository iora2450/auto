...
<section class="forms">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => 'sales.store', 'method' => 'post', 'files' => true, 'class' => 'payment-form', 'onsubmit' => 'handleSubmit()']); ?>
    ...
    <div class="form-group">
        <label>
            <strong>Casa Exportador</strong>
        </label>
        <input type="text" name="casa_exportador" class="form-control"/>
    </div>
</div>
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="text" name="facturas" class="form-control"/>
    </div>
</div>
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="text" name="duca" class="form-control"/>
    </div>
</div>
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="text" name="aduana" class="form-control"/>
    </div>
</div>
                                ...
                                <div class="form-group"> 
                                    <?php echo Form::submit(trans('file.submit'), ['class' => 'btn btn-primary', 'id' => 'submit-button']); ?>

                                </div>
                                <div class="form-group" id="back-button-container" style="display: none;">
...
<script type="text/javascript">
    function handleSubmit() {
        ...
        // No usar event.preventDefault() para permitir el envío del formulario
    }
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag){
                ...
                cols += '<td>' + data[1] + '</td>';
                cols += '<td><input type="number" class="form-control qty" name="qty[]" value="1" readonly step="any" required/></td>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/frankdev/public_html/auto/resources/views/sale/create.blade.php ENDPATH**/ ?>