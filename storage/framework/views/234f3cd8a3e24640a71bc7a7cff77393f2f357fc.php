...
<section>
    <div class="container-fluid">
        ...
        <a href="<?php echo e(route('excluded.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.Excluded')); ?></a>&nbsp;
        <?php endif; ?>
    </div>
        ...
        <table id="biller-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Dui')); ?></th>
                    <th><?php echo e(trans('file.Nit')); ?></th>
            ...
            <tbody>
                <?php $__currentLoopData = $lims_excluded_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$biller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr data-id="<?php echo e($biller->id); ?>">
                    <td><?php echo e($key); ?></td>                   
                    <td><?php echo e($biller->name); ?></td>                    
                    <td><?php echo e($biller->dui); ?></td>
                    <td><?php echo e($biller->nit); ?></td>
                    <td><?php echo e($biller->email); ?></td>
                    <td><?php echo e($biller->phone); ?></td>
                    <td><?php echo e($biller->address); ?>

                        <?php if($biller->state_id): ?><?php echo e(', '.$biller->estado->name); ?><?php endif; ?>
                        <?php if($biller->municipality_id): ?><?php echo e(', '.$biller->municipio->name); ?><?php endif; ?>
                    </td> 
                    <?php if($biller->is_active): ?>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a href="<?php echo e(route('excluded.edit', $biller->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></a> 
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/factue/resources/views/excluded/index.blade.php ENDPATH**/ ?>