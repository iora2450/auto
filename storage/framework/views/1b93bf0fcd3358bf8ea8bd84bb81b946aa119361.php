...
<!-- Agrega el siguiente script para manejar la selección de facturas -->
<script>
    $(document).ready(function () { 
        $(".select-button").click(function () {
            var reference = $(this).data("reference");
            // Haz lo que necesites con la referencia seleccionada
            alert("Factura seleccionada: " + reference);
        });
    });
</script>
<script>
    $(document).ready(function () {
        // Abrir la modal cuando se haga clic en el botón
        $("#openSearchModal").click(function () {
            $("#searchInvoicesModal").modal("show");
        });
        ...
        $("#searchForm").submit(function (e) {
            ...
            // Enviar una petición AJAX para obtener los resultados
            $.ajax({
                type: "GET",
                ...
                success: function (response) {
                    ...
                    error: function () {
                    $("#searchResults").html("<p>Error al cargar los resultados.</p>");
                }
            });
        });
    });
...
<div class="modal fade" id="searchInvoicesModal" tabindex="-1" role="dialog" aria-labelledby="searchInvoicesModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 110%;"> <!-- Aumentar en un 10% -->
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="searchInvoicesModalLabel">Búsqueda de Facturas</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="searchForm" action="<?php echo e(route('sale.search_invoices')); ?>" method="GET" class="search-form">
                    <div class="form-group">
                        <label for="reference_no">Número de Referencia:</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            Si
                                            <input type='radio' name='licitacion' value='on' checked="checked">
                                            No 
                                            <input type="radio" name='licitacion' value='off'>
                                        </div>

                                        <div class="form-group">
                                            <label><b>Terceros</b></label>
                                            No
                                            <input type='radio' name='tercero' id="comision" value='on' checked="checked">
                                            Si 
                                            <input type="radio" name='tercero' id="canon" value='off'>
                                        </div>
                                    </div>                                  
                                </div> 

                                <!-- En la vista donde tienes el botón para abrir la ventana emergente -->
                                <div id="divSearch" name="divSearch" class="form-group" style="display: none;">
                                    <div class="row">                                                                        
                                        <div class="col-md-6">
                                            <label for="numeroControlInput">DTE A para el documento  Anexar:</label>
                                            <input type="text" id="numeroControlInput" name="numeroControlInput" class="form-control">
                                        </div>

                                        <div class="col-md-6">
                                            <label for="dateSale">Fecha del documento Anexar:</label>
                                            <input type="text" id="dateSale" name="dateSale" class="form-control">    
                                        </div>    
                                    </div>
                                   
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#searchInvoicesModal">
                                        Buscar Facturas
                                    </button> 
                                </div>
                ...
                <form>
                    ...
                    <div id="edit_unit" class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="edit_description" id="edit_description" class="form-control entrada-usuario" ></textarea>
                        </div>
...
<script>
    $(document).ready(function () {
        $(".select-button").click(function () {
            ...
            var fechasale = $(this).data("created_at");
    ...
    $("#document_id").change(function(){
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                $("#reference_no").val(data[0]["correlativo"])
            }
        });
    })
    ...
    $(document).ready(function () {
        ...
        //   alert(selectedValue);
            if (selectedValue === "3" || selectedValue === "4") {
                divSearch.show();
                divSearch.find(":input").prop("required", true); // Hace que los campos sean requeridos
            } else {
                divSearch.hide();
                divSearch.find(":input").prop("required", false); // Quita la propiedad requerida
            }
        });
    });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltygkxsm/public_html/mrjbnew/resources/views/return/create.blade.php ENDPATH**/ ?>