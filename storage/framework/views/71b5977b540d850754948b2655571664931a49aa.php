        ...
        <table id="return-table" class="table return-list">
            ...
            <tbody>
                ...
                <tr class="return-link" data-return='["<?php echo e(date($general_setting->date_format, strtotime($return->created_at->toDateString()))); ?>", "<?php echo e($return->reference_no); ?>", "<?php echo e($return->warehouse->name); ?>", "<?php echo e($return->warehouse->phone); ?>", "<?php echo e($return->warehouse->address); ?>", "<?php echo e($supplier->name); ?>", "<?php echo e($supplier->company_name); ?>","<?php echo e($supplier->email); ?>", "<?php echo e($supplier->phone_number); ?>", "<?php echo e($supplier->address); ?>", "<?php echo e($supplier->city); ?>", "<?php echo e($return->id); ?>", "<?php echo e($return->total_tax); ?>", "<?php echo e($return->total_discount); ?>", "<?php echo e($return->total_cost); ?>", "<?php echo e($return->order_tax); ?>", "<?php echo e($return->order_tax_rate); ?>", "<?php echo e($return->grand_total); ?>", "<?php echo e($return->return_note); ?>", "<?php echo e($return->staff_note); ?>", "<?php echo e($return->user->name); ?>", "<?php echo e($return->user->email); ?>", "<?php echo e($return->document); ?>"]'>
                    ...
                    <td><?php echo e($return->invoice); ?></td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a href="<?php echo e(route('return-purchase.download', $return->id)); ?>" class="btn btn-link">
                                        <i class="dripicons-download"></i>
                                        <?php echo e(trans('file.Download')); ?>

                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('return-purchase.document', $return->id)); ?>" class="btn btn-link" target="_blank" rel="noopener noreferrer">
                                        <i class="dripicons-zoom-out"></i> 
                                        <?php echo e(trans('file.Attach')); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/mrjbinve/public_html/factue/resources/views/return_purchase/index.blade.php ENDPATH**/ ?>