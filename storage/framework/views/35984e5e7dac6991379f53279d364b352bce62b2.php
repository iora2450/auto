...
<?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <tr>
        ...
        <td><?php echo e($comp->numerocontrol); ?></td>
        <td><?php echo e($comp->codgeneracion); ?></td>
        <td><?php echo e($comp->sello); ?></td>
        <?php if($comp->tercero == "off"): ?>
            <td><?php echo e($comp->reference_no); ?></td>
        <?php else: ?>
            <td class="text-danger"><?php echo e($comp->reference_no); ?></td>
        <?php endif; ?>
        <td><?php echo e($comp->tax_no); ?></td>
        <td><?php echo e($comp->nit); ?></td>
        ...
        <td class="text-right">$<?php echo e(number_format($comp->subtotal - $comp->total_exenta, 2)); ?></td>
        <td class="text-right">$<?php echo e(number_format($comp->impuesto, 2)); ?></td>
        <td class="text-right">$<?php echo e(number_format($comp->total_exenta, 2)); ?></td>
        <!-- Percepción (según lógica actual, se muestra $0.00) -->
        <td class="text-right">$0.00</td>
        <!-- Servicio de Transporte -->
        <td class="text-right">$<?php echo e(number_format($comp->servicio_trasporte, 2)); ?></td>
        <!-- Servicios de Aduana -->
        <td class="text-right">$<?php echo e(number_format($comp->servicio_aduana, 2)); ?></td>
        <!-- Gastos por cuenta del cliente (net_unit_price cuando tax_rate es 0 para producto 705) -->
        <td class="text-right">$<?php echo e(number_format($comp->gastos_por_cuenta_cliente, 2)); ?></td>
        <?php if($comp->identification_type == "1"): ?>
            <td class="text-right">$<?php echo e(number_format($comp->total_exenta, 2)); ?></td>
        <?php else: ?>
            <td class="text-right">$<?php echo e(number_format($comp->total, 2)); ?></td>
        <?php endif; ?>
    </tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <tr>
        ...
        <td class="text-right">$<?php echo e(number_format($stotal, 2)); ?></td>
        <td class="text-right">$<?php echo e(number_format($sniva, 2)); ?></td>
        <td class="text-right">$<?php echo e(number_format($sexentoTotal, 2)); ?></td>
        <td class="text-right">$0.00</td>
        <td class="text-right">$<?php echo e(number_format($sTransporteTotal, 2)); ?></td>
        <td class="text-right">$<?php echo e(number_format($sAduanaTotal, 2)); ?></td>
        <td class="text-right">$<?php echo e(number_format($sGastosCuentaCliente, 2)); ?></td>
        <td class="text-right">$<?php echo e(number_format($stotal + $sniva + $sexentoTotal, 2)); ?></td>
    </tr>
</tfoot>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tramites/public_html/auto/resources/views/sale/report.blade.php ENDPATH**/ ?>