    ...
    <?php $__currentLoopData = $lims_product_sale_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_sale_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr>
            ...
            <td style="width:5px; text-align: right;">
                <?php echo e(number_format((float)($precio_unitario), 2, '.', '')); ?>

            </td>
            <td style="width:3px;text-align: right;"><?php echo e(number_format((float)$ventas_exentas, 2, '.', ',')); ?></td>
...
<table class="default">
    <tr>
        ...
        <td style="width:3px; text-align: right;">
            <?php echo e(number_format((float)$ventas_exentas_total, 2, '.', ',')); ?>
    ...
    <tr>
        ...
        <td style="width:3px; text-align: right;">
            <?php echo e(number_format((float)$ventas_gravadas_total, 2, '.', ',')); ?>
    ...
    <tr>
        ...
        <td style="width:3px; text-align: right;">
            <?php echo e(number_format((float)($ventas_exentas_total + $ventas_gravadas_total), 2, '.', ',')); ?>
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        ...
                        <td style='width:8%; text-align: right; padding-left: 20px; padding-right: 1px;'>
                            <?php echo e(number_format((float)$lims_sale_data->grand_total-$ventas_exentas_total, 2, '.', ',')); ?>
...
<?php /**PATH /home/frankdev/public_html/auto/resources/views/sale/factdte.blade.php ENDPATH**/ ?>