...
<body> 
    <?php $__currentLoopData = $pdfData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row">             
                    <div class="col-4">
                        <div class="textContri" style="margin-top: 40px; padding-left: 150px;">
                            <p class="dte">Código generación: <?php echo e($data['lims_sale_data']->codgeneracion); ?></p>
                            <br>
                            <p class="dte">Número de control: <?php echo e($data['lims_sale_data']->numerocontrol); ?></p>
                            <br>
                            <p class="dte">Sello de recepción: <?php echo e($data['lims_sale_data']->sello); ?></p>
                            <br>
                            <div class="row dte">                            
                                <div class="col-6">
                            ...
                            <div class="row dte">                            
                                ...
                                <div class="col-6">
                                    <p class="dte" style="margin-left: 3px;">
                                        Fecha de emisión: <?php echo e(\Carbon\Carbon::parse($data['lims_sale_data']->created_at)->format('dmY')); ?>
                            ...
                            <div class="row dte">                            
                                <div class="col-6">
                                    <p class="dte">Hora de emisión: <?php echo e(\Carbon\Carbon::parse($data['lims_sale_data']->created_at)->toTimeString()); ?></p>
                                </div>                        
                            </div>
                        </div>
                    <div class="col-4"></div>
    ...
    <div id="receipt-data">
        ...
        <div class="container-fluid" id="tabla1">
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td id=cabtab3 style='width: 67.8%;'>Valor en letras: <?php echo e($data['todo']); ?></td>
                        <td style='text-align: left;'>Sumas de ventas:</td>
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 110%; font-size: 9px;'>Nombre entrega: <?php echo e($data['userName']); ?></td>
                        <td style='width: 80%; text-align: left; padding-left: 2px; padding-right: 40px;'>No. Documento: <?php echo e($data['userNit']); ?></td>
                        <?php if($lims_sale_data->discount > 0): ?>
...
<?php /**PATH /home2/mrjbinve/public_html/factue/resources/views/sale/ccf.blade.php ENDPATH**/ ?>