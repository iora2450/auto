...
<div class="container-fluid" id="tabla1">
    ...
    <?php endif; ?>
            ...
            <td style="width:3px;"><?php echo e(number_format((float)$is_exempt, 2, '.', '')); ?></td>
            <td style="width:3px;"></td>
            <td style="width:3px; "></td>
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        ...
                        <td style='width:8%; text-align: right; padding-left: 20px; padding-right: 1px;'>
                            <?php echo e(number_format((float)$lims_sale_data->grand_total-$ventas_exentas, 2, '.', ',')); ?>
...
<?php /**PATH /home/frankdev/public_html/auto/resources/views/sale/efact.blade.php ENDPATH**/ ?>