    ...
    <div id="receipt-data">
        ...
        <div class="container-fluid" id="tabla1">  
            ...
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 225%; text-align: left; font-size: 9px;'>Valor en letras: <?php echo e($data['todo']); ?></td>
                    </tr>
                </table>
            </div>
        ...
        <div class="container-fluid" id="tabla1">  
            <div class="">
                <table style='min-height:10px; max-height:10px;'>
                    <tr>
                        <td style='width: 127%; font-size: 9px;'>Responsable por parte del Emisor: <?php echo e($data['userName']); ?></td>
                        <td style='width: 100%; text-align: left; padding-left: 2px; padding-right: 40px;'>No. Documento: <?php echo e($data['userNit']); ?></td>
                    </tr>
                </table>
            </div>
...
<?php /**PATH /home2/mrjbinve/public_html/factue/resources/views/sale/factura.blade.php ENDPATH**/ ?>